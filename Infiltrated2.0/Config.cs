...
namespace Infiltrated
{
    public class Config : IConfig
    {
        ...
        public List<ItemType> InfiltratedItems { get; private set; } = new List<ItemType>() { ItemType.KeycardScientistMajor, ItemType.KeycardSeniorGuard, ItemType.Medkit };
        ...
        public Exiled.API.Features.Broadcast InfiltratedBroadcastDeath { get; private set; } = new Exiled.API.Features.Broadcast("<color=aqua>The infiltrated <color=red>{player}</color> has been!</color>", 10);
