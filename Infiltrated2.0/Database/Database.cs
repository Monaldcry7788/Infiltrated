    ...
    public class Database
    {
        ...
        public void Open()
        {
            try
            {
                ...
                LiteDatabase.GetCollection<Player>().EnsureIndex(p => p.TotalKill);
                LiteDatabase.GetCollection<Player>().EnsureIndex(p => p.TotalDeath);
                LiteDatabase.GetCollection<Player>().EnsureIndex(p => p.TotalShotsFired);
            }
            catch (Exception e)
            {
